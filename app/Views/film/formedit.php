...
<?= form_open_multipart('film/updatedata') ?>

<div class="row mb-3 justify-content-center">
    <label for="" class="col-sm-2 col-form-label">Kode Film</label>
    <div class="col-sm-6">
        <input type="text" class="form-control" id="kodefilm" name="kodefilm" readonly value="<?= $kodefilm; ?>">
    </div>
</div>
...
<div class="row mb-3 justify-content-center">
    ...
    <div class="col-sm-6">
        <input type="text" class="form-control" id="jadwalfilm" name="jadwalfilm" value="<?= $jadwalfilm; ?>">
    </div>
</div>
