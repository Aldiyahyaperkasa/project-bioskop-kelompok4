...
<head>
    ...
    <title>Daftar Akun - App Bioskop Raf</title>
    <!-- Bootstrap CSS -->
        ...
        <form method="post" action="/register/process">
            ...
            <div class="mb-3">
                <p class="text-light">sudah punya akun ?
                    <a class="text-decoration-none" href="<?= site_url('login/index') ?>">
                        halaman login
                    </a>
                </p>
                <button type="submit" class="btn d-flex justify-content-center">Register</button>
            </div>
        </form>
    </div>
